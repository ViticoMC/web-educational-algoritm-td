...
export default function ClaveCandidata({ relaciones }: { relaciones: Relacion[] }) {
    ...
    function handleAspirina() {
        ...
        const res = isCandidatClave({
            posibleClaveCAndidata: selectedAtributos,
            conjuntoDF: selectedConjuntoDf?.df,
    ...
    return (
        <section className='flex flex-col gap-4 items-center p-4'>
            ...
            {
                result === "succes" ? <p className="text-green-400">El conjunto es Clave Candidata</p>
                    : result === "failed" ? <div>
