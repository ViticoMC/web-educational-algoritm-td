    ...
    return (
        <nav className="h-screen w-64 bg-linear-to-b from-white via-slate-50 to-white dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 border-r border-slate-200 dark:border-slate-700 shadow-lg p-6 overflow-y-auto transition-colors duration-300">
            ...
            <div className="mb-8">
                <Link href="/" className="flex items-center gap-3 mb-2">
                    ...
                    <div className="flex flex-col">
                        <span className="font-bold text-slate-900 dark:text-white">Teoría de BD</span>
                        <span className="text-xs text-slate-500 dark:text-slate-400">LABORATORIO EDUCATIVO</span>
                    </div>
                </Link>
            </div>
            ...
            <div className="space-y-1">
                ...
                <Link
                    href="/"
                    className={`flex items-center gap-3 px-4 py-2 rounded-lg transition-all duration-200 ${isActive('/') && pathname !== '/algoritmos'
